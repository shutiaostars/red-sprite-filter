# Red Sprite Filter v1.0.1

Bug-fix macOS desktop release that bundles numpy and Pillow to avoid ModuleNotFoundError on other Macs.
...
```text
6592d366d05a6cc46f9aa68486f4b553b360e722a1063c28e0a73f61f6381b7f
```
...
1. Download `red-sprite-filter-1.0.1.dmg`
2. Open the DMG
...
macOS 桌面修复版，已内置 numpy 和 Pillow，避免其他电脑扫描时出现 ModuleNotFoundError。
...
1. 下载 `red-sprite-filter-1.0.1.dmg`
2. 打开 DMG
...
# Red Sprite Filter v1.0.1（日本語）

最numpy と Pillow を同梱し、他の Mac での ModuleNotFoundError を避ける macOS デスクトップ修正版です。
...
1. `red-sprite-filter-1.0.1.dmg` をダウンロード
2. DMG を開く
...
# Red Sprite Filter v1.0.1 (Español)
...
1. Descarga `red-sprite-filter-1.0.1.dmg`
2. Abre la DMG
...
# Red Sprite Filter v1.0.1 (Deutsch)
...
1. Lade `red-sprite-filter-1.0.1.dmg` herunter
2. Öffne die DMG
