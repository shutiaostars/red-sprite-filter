...
![红色精灵候选结果与人工复核界面](docs/images/candidate-review.jpg)

上图展示 `精灵合集.mp4` 的实际筛选结果：软件在完整视频中列出 7 个候选事件，并按原视频时间显示候选帧、疑似等级和评分。右侧可以查看关键帧、播放候选片段、阅读红像素与强度信息，再标记为“确认”“疑似”或“排除”。
